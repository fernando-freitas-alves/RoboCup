...
///////////////////////////////////////////////////////////////////
    ...
    class_<NEATConnection>("NEATConnection", init<>())
            .def_readwrite("source_neuron_idx", &NEATConnection::m_source_neuron_idx)
            .def_readwrite("target_neuron_idx", &NEATConnection::m_target_neuron_idx)
            .def_readwrite("weight", &NEATConnection::m_weight)
            .def_readwrite("recur_flag", &NEATConnection::m_recur_flag)
            .def_readwrite("hebb_rate", &NEATConnection::m_hebb_rate)
            .def_readwrite("hebb_pre_rate", &NEATConnection::m_hebb_pre_rate)
            ;
...
/////////////////////////////////////////////////////////
    ...
    class_< std::vector<NEATConnection> >("ConnectionList")
            .def(vector_indexing_suite< std::vector<NEATConnection> >() )
            ;
