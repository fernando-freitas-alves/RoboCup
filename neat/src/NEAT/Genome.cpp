...
namespace NEAT
{
    ...
    */
    ...
    void Genome::Clean_Net(std::vector<NEATConnection> &connections, unsigned int input_count,
                           unsigned int output_count, unsigned int hidden_count)
    {
        ...
        std::vector<NEATConnection> temp;
        ...
        while (loose_connections)
        {
            ...
            std::vector<NEATConnection>::iterator itr;
