...
public:
    ...
    bool operator==(NEATConnection const& other) const
    {
...
public:
    ...
    std::vector<NEATConnection> m_connections; // array size - number of connections
    ...
    void AddConnection(const NEATConnection& a_c) { m_connections.push_back( a_c ); }
    NEATConnection GetConnectionByIndex(unsigned int a_idx) const
    {
